...
import {
	...
	postRole,
	putRole,
} from 'src/app/store/slices/settingsPage/roles/rolesAsyncThunks';
...
const AddRole = ({
	...
	const handleSubmit = (values: AddRolesInterface) => {
		...
		// 	  })
		// 	:
		dispatch(postRole(values)).then((promiseResponse: any) => {
			if ((promiseResponse.payload.code = 200)) {
        handleClose()
			}
		});
	...
	console.log('form errors', formStore.formState.errors);
	return (
		<Form {...formStore}>
